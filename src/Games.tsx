        ...
        <div className="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center z-50">
          ...
          >
            ...
            <button
              ...
              className="absolute top-2 right-4 z-10 bg-purple-500 text-white rounded px-2 py-1"
            >
              {sidebarVisible ? 'Hide Details' : 'Show Details'}
            </button>
            <div className={`flex flex-col ${sidebarVisible ? '' : 'hidden'}`}>
              <h2 className="font-head text-2xl mb-2 text-white text-center">
                {popup.game?.title}
              </h2>
              <p className="text-white/80 text-base text-center max-w-xs mx-auto mb-4">
            ...
            <iframe
              ...
              style={{ marginTop: sidebarVisible ? '16px' : '0' }} // Adjust iframe margin based on sidebar visibility
            ></iframe>
