    ...
    <div className="bg-[var(--wope-bg)] min-h-screen text-white flex flex-col justify-between">
      <main className="flex-1 py-16 px-2 flex flex-col items-center">
        ...
        <button
          ...
          className="transition px-4 py-2 rounded-lg bg-[var(--wope-purple)]/10 mb-6 hover:bg-[var(--wope-blue)]/10 focus:outline-none focus:ring-2 focus:ring-[var(--wope-purple)] text-2xl"
        >
          {quote}
        </button>
        <form className="w-full max-w-md flex flex-col items-center gap-3 bg-white/5 border border-white/10 rounded-2xl px-6 py-8 shadow-lg mt-2">
